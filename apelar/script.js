var log, loggeduser, banned = true;
...
window.onload = async function () {
    ...
    if (loggeduser != undefined) {
        if (loggeduser.data.expiration < Date.now()) {
            ...
            document.getElementById("bannedErr").hidden = banned
            document.getElementById("infonoban").hidden = banned
            document.getElementById("infoban").hidden = !banned
            document.getElementById("startButton").disabled = !banned
